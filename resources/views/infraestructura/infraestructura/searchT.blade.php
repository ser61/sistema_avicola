{!! Form::open(array('url'=>'infraestructura/infraestructura','method'=>'GET','autocomplete'=>'off','role'=>'search')) !!}
	...
	<div class="panel-body">
		<div class="input-group margin">
			<input type="text" class="form-control" name="searchText" placeholder="Buscar por ID de Registro..." values="{{$searchText}}">
                ...
                <span class="input-group-btn">
                  <a href="infraestructura/create" class="btn btn-danger btn-flat">
