            ...
            @foreach($ordenes as $ord)
              <tr>
                ...
                <td>
                  ...
                  <a href="" data-target="#modal-delete-{{$ord->id}}" data-toggle="modal" class="btn btn-danger" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a>
                </td>
              </tr>
            @endforeach
            </tbody>
