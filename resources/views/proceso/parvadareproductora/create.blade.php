  ...
  <div class="toolbar row">
    <div class="page-header">
      <h1 style="text-align: center;">* * * P R O C E S O * * *
        <small> Sección de las Parvada de Reproductora </small>
      </h1>
    </div>
  </div>
  <!-- end: TOOLBAR -->
    ...
    <div class="col-sm-10 col-sm-offset-1">
      <div class="panel panel-white">
        ...
        <div class="panel-heading">
          <h2 class="panel-title center">Panel de Registro de las <span class="text-bold">Parvada de Reproductora</span></h2>
		...
		<div class="panel-body">
          ...
          {!!Form::open(array('url'=>'proceso/parvadareproductora','method'=>'POST','autocomplete'=>'off'))!!}
			{{Form::token()}}
