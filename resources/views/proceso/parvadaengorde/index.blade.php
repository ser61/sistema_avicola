  ...
  <div class="toolbar row">
    <div class="page-header">
      <h1 style="text-align: center;">* * * P R O C E S O * * *
        <small> Sección de Parvada de Engorde </small>
      </h1>
    </div>
  </div>
  <!-- end: TOOLBAR -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-white">
        <div class="panel-heading">
          <h2 class="panel-title center">Panel de control de las <span class="text-bold">Parvada de Engorde</span></h2>
        ...
        @include('proceso.parvadaengorde.search')
            ...
            @foreach($parvadas as $par)
              <tr>
                ...
                <td class="center">
					...
					<a href="" data-target="#modal-delete-{{$par->id}}" data-toggle="modal" class="btn btn-xs btn-red tooltips" data-placement="top" data-original-title="Finalizar Ciclo Reproductivo"><i class="fa fa-times fa fa-white"></i></a>
                </td>
              </tr>
              @include('proceso.parvadaengorde.modal')
            @endforeach
            </tbody>
