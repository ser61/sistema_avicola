...
@section('content')
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{url('/empleado')}}">Index</a></li>
      ...
      <div class="col-md-10 col-sm-offset-1">
        <div class="box box-primary">
          ...
          <div class="box-header with-border">
            <h3 align="center">Panel de Edicion de <span class="text-bold">{{ $empleado->apellido }}</span> {{ $empleado->nombre }}</h3>
          </div>
          ...
          <div class="box-body">
            ...
            <div class="col-sm-8 col-sm-offset-2">
              ...
              <div class="form-group">
                <label>Telefonos del empleado:</label>
                <div id="telefonoBody">
                  @if(count($telefonos) > 0)
                    @foreach($telefonos as $telefono)
                      <div class="input-group" style="margin-bottom: 10px">
                        ...
                        <input type="number" name="telefonoEditar[]" value="{{ $telefono->numero }}" class="form-control" placeholder="Ingrese el telefono del empleado aqui...">
                      </div>
                    @endforeach
                  @endif
                </div>
              ...
              <div class="form-group">
                <div class="col-sm-8 col-sm-offset-2">
                  ...
                  <button type="submit" class="btn btn-primary btn-block">
                    Actualizar Empleado <i class="fa fa-arrow-circle-right"></i>
                  </button>
                  <br>
                </div>
              </div>
